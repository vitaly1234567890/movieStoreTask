        ...
        <div className={s.content}>
          <div>
            ...
            <div className={s.rating}>
              ...
              <span className={s.ratingGrade}>
                {data?.vote_average.toFixed(1)}{" "}
              </span>
              <span className={s.voteCount}>
                {" "}
                ({data && FormatNumber(data.vote_count)})
              </span>
            </div>
          </div>
          <div className={s.descriptionsContainer}>
            <div className={s.container}>
              ...
              <span className={s.descriptionOptions}>
                {data && formatMinutes(data.runtime)}
              </span>
            </div>
            <div className={s.container}>
              <span className={s.description}>Premiere</span>
              <span className={s.descriptionOptions}>
                {data && formatDate(data.release_date)}
              </span>
            </div>
            <div className={s.container}>
