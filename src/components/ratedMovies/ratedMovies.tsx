...
export const RatedMovies = () => {
    ...
    const ratedMovies = useSelector((state: RootState) => state.ratedMovies.ratedMovies);
    const [filteredRatedMovies, setFilteredRatedMovies] = useState<Movies[]>(ratedMovies)
        ...
        <div className={s.root}>
            {ratedMovies.length === 0 ?
                <div className={s.noMovie}>
                    <Icons width={"400"} height={"300"} viewBox={"0 0 400 300"} iconId={"ratedMovies"}/>
                ...
                <div>
                    <div className={s.titleInput}>
                        ...
                        <InputWithButton  onSearch={handleSearch} value={search} onChange={onChangeSearch} onEnterPress={onEnterPress} />
                    </div>
                    ...
                    <div className={s.paginationWrapper}>
                        <div className={s.paginator}>
                            <Pagination
                                ...
                                value={activePage}
                                onChange={setPage}
                                total={Math.ceil(filteredRatedMovies.length / itemsPerPage) || 0}
                            />
                        </div>
                    </div>
                </div>
